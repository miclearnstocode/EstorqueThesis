...
from import_functions import import_grading_sheet, import_student_data
...
class Application(tk.Tk):
    ...
    def import_grading_sheet(self, year, semester):
        title = f"Grading Sheet for {year} {semester}"
        grading_data = import_grading_sheet(title)
        if grading_data:
            print(f"Processed {year} {semester} grading sheet data")
            # Implement further processing or display of the grading data here
    ...
    def import_existing_curriculum(self):
        title = "Existing Curriculum (CSV)"
        curriculum_data = import_student_data(title)
        if curriculum_data:
            print(f"Processed existing curriculum data from {title}")
            # Implement further processing or display of the curriculum data here

    def import_new_curriculum(self):
        title = "New Curriculum (CSV)"
        curriculum_data = import_student_data(title)
        if curriculum_data:
            print(f"Processed new curriculum data from {title}")
            # Implement further processing or display of the curriculum data here
    ...
    def import_archive(self, archive_type):
        title = f"{archive_type} Archive"
        archive_data = import_student_data(title)
        if archive_data:
            print(f"Processed {archive_type} archive data from {title}")
            # Implement further processing or display of the archive data here
