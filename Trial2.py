...
class Application(tk.Tk):
    ...
    def curriculum_screen(self):
        ...
        ttk.Button(import_frame, text="Import Existing Curriculum (CSV)", command=self.import_existing_curriculum).pack(side=tk.LEFT, padx=5)
        ttk.Button(import_frame, text="Import New Curriculum (CSV)", command=self.import_new_curriculum).pack(side=tk.LEFT, padx=5)
    ...
    def archive_screen(self):
        ...
        ttk.Button(import_frame, text="Import Regular Archive", command=lambda: self.import_archive("Regular")).pack(side=tk.LEFT)
        ttk.Button(import_frame, text="Import Irregular Archive", command=lambda: self.import_archive("Irregular")).pack(side=tk.LEFT)
